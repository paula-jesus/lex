...
for column in ['Auditoria', 'Auto avaliação', 'Aderência ao Plano de Capacitação da Qualidade definido para a Base']:
    dados_planilha[column] = pd.to_numeric(dados_planilha[column], errors='coerce')

for column in ['Auditoria', 'Auto avaliação','Atendimento ao SLA (%) Agências', 'OPAV', 'Produtividade', 'Loss Rate ($)', 'Absenteísmo (%)', 'Aderência ao Plano de Capacitação da Qualidade definido para a Base', 'Inventario (%) Agências', 'Custo/ Pacote ($) XDs', 'Total de ocorrências de +2HE', 'Total de ocorrências de -11Hs Interjornadas']:
...
dados_metas_planilha.rename(columns={'Absenteísmo (%)': 'Absenteísmo','Total de ocorrências de +2HE': 'Ocorrências de +2HE', 'Total de ocorrências de -11Hs Interjornadas':'Ocorrências de -11Hs Interjornadas', 'Produtividade':'Produtividade Média', 'Atendimento ao SLA (%) Agências': 'SLA', 'Inventario (%) Agências': 'Inventário'}, inplace=True)
dados_pesos.rename(columns={'Absenteísmo (%)': 'Absenteísmo','Total de ocorrências de +2HE': 'Ocorrências de +2HE', 'Total de ocorrências de -11Hs Interjornadas':'Ocorrências de -11Hs Interjornadas', 'Produtividade':'Produtividade Média', 'Atendimento ao SLA (%) Agências': 'SLA', 'Inventario (%) Agências': 'Inventário'}, inplace=True)
